...
class MenuDirector:
    ...
    def opcion1(self, unaColeccionPersonal: IDirector):
        ...
        if resultado:
            ...
            print("No se encontro un agente con cuil {0}".format(cuil))
    ...
    def opcion2(self, unaColeccionPersonal: IDirector):
        ...
        if resultado:
            ...
            print("No se encontro un docente con cuil {0}".format(cuil))
    ...
    def opcion3(self, unaColeccionPersonal: IDirector):
        ...
        if resultado:
            ...
            print("No se encontro un personal de apoyo con cuil {0}".format(cuil))
    ...
    def opcion4(self, unaColeccionPersonal: IDirector):
        ...
        if resultado:
            ...
            print("No se encontro un docente-investigador con cuil {0}".format(cuil))
